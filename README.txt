...
This is the readme for ShrekOnline, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. ShrekOnline) > Ok.
...
- To run the project find ShrekOnline.java (which will be in under src/main/java/org/amogustechnologies) and right click > Run 'ShrekOnline'
